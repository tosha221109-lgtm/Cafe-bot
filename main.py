...
users = load_users()
uid = str(user.id)
now = **import**(“datetime”).datetime.now().strftime(”%Y-%m-%d %H:%M:%S”)
if uid not in users:
...
"🍷 Вино": [
    {"name": "Cielo Bio Bio Bubbles, экстра драй", "description": "125 мл / 750 мл, Италия, Сицилия. Аромат цитрусов и зелёных фруктов", "price": 345},
    ...
    {"name": "Херес Tio Toto Cream", "description": "100 мл", "price": 455},
    {"name": "Херес Tio Toto Fino", "description": "100 мл", "price": 455},
],
"🍺 Пиво": [
    ...
    {"name": "Oklers Weizen (разливное)", "description": "250 мл, Пл. 11%, Алк. 4.5%", "price": 235},
    {"name": "Oklers Weizen (разливное)", "description": "400 мл, Пл. 11%, Алк. 4.5%", "price": 365},
    {"name": "Pilsner Murquell (разливное)", "description": "250 мл, Пл. 12%, Алк. 4.8%", "price": 235},
    {"name": "Pilsner Murquell (разливное)", "description": "400 мл, Пл. 12%, Алк. 4.8%", "price": 365},
],
"🔥 Крепкий алкоголь": [
    {"name": "Whitley Artisanal Vodka Gold", "description": "40 мл, водка", "price": 155},
    {"name": "Чайковский", "description": "40 мл, водка", "price": 190},
    {"name": "Белуга Нобл", "description": "40 мл, водка", "price": 230},
    {"name": "Whitley Neill Dry Gin", "description": "40 мл, джин", "price": 265},
    {"name": "Whitley Neill Rhubarb&Ginger", "description": "40 мл, джин", "price": 265},
    {"name": "Bulldog", "description": "40 мл, джин", "price": 315},
    {"name": "Drumshanbo Gunpowder Irish Gin", "description": "40 мл, джин", "price": 365},
    {"name": "Mare Gin", "description": "40 мл, джин", "price": 475},
    {"name": "Dead Mans Finger Black", "description": "40 мл, ром", "price": 295},
    {"name": "Nusa Cana Tropical Island", "description": "40 мл, ром", "price": 355},
    {"name": "Matusalem Solera 7", "description": "40 мл, ром", "price": 395},
    {"name": "Кизляр 3*", "description": "40 мл, коньяк", "price": 230},
    {"name": "Арарат 3*", "description": "40 мл, коньяк", "price": 245},
    {"name": "Camus VS", "description": "40 мл, коньяк", "price": 490},
    {"name": "Camus VSOP", "description": "40 мл, коньяк", "price": 645},
    {"name": "Dead Mans Fingers Reposado", "description": "40 мл, текила", "price": 295},
    {"name": "Cuerno de Toro Blanco", "description": "40 мл, текила", "price": 355},
    {"name": "Raicilla Estancia", "description": "40 мл, мескаль", "price": 655},
    {"name": "Jagermeister", "description": "40 мл, ликёр", "price": 285},
    {"name": "Sambuca", "description": "40 мл, ликёр", "price": 265},
    {"name": "Aperol Aperitivo", "description": "40 мл, вермут", "price": 245},
    {"name": "Campari Bitter", "description": "40 мл, биттер", "price": 265},
    {"name": "Fernet Branca", "description": "40 мл, биттер", "price": 275},
],
"🥂 Шоты и лонги": [
